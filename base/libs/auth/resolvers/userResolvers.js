        ...
        register: async (parent, args, context, info) => {
            ...
            try {
                ...
                if (!email.toLowerCase().includes('test.com')) {
                    ...
                    //TODO REMOVE ELSE ON PLATFORM WHEN THE MOBILE APP IS ABLE TO DEFINE ITS OWN PLATFORM TYPE
                    await context.dataSources.slackAPI.sendMessage(`New Lendbox User \n Email Address: ${email.toLowerCase()} \n Platform: ${args.user.platform ? args.user.platform : "Android App"}`)
                }
